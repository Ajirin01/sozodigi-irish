      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
          ...
          {specialist.practicingLicense ? (
            <a
              href={specialist.practicingLicense.startsWith('http') ? specialist.practicingLicense : `${process.env.NEXT_PUBLIC_NODE_BASE_URL || ''}${specialist.practicingLicense.startsWith('/') ? '' : '/'}${specialist.practicingLicense}`}
              target="_blank"
